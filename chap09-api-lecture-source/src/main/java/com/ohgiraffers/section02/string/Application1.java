...
public class Application1 {
    public static void main(String[] args) {
        ...
        *  substring(): 문자열의 일부분을 잘라내어 새로운 문자열 반환*/
        ...
        /*필기.
        *  replace(): 문자열에서 대체할 문자열로 기존 문자열을 변경하여 반환*/
        ...
        *  length(): 문자열의 길이를 정수형으로 반환*/
        ...
        /*필기.
        *  isEmpty(): 문자열의 길이가 0인 경우에 true, 아니면 false를 반환*/
