...
public class Application1 {
    public static void main(String[] args) {
        ...
        /*설명. 기본 자료형을 Wrapper 클래스 자료형으로 변환 가능(boxing)*/
        Integer boxingInt = (Integer)intValue;
        Integer boxingInt2 = Integer.valueOf(intValue);

        /*설명. Wrapper 클래스 자료형 기본 자료형으로 변환 가능(unboxing)*/
        int unboxingValue = boxingInt.intValue();

        /*설명. 기본 자료형과 Wrapper 클래스는 자동으로 boxing/unboxing (auto-(un)boxing)*/
        ...
        /*설명. Wrapper 클래스 값 비교*/
        /*설명. Wrapper 클래스들도 리터럴(literal) 값으로 auto-boxing하면 동일한 객체 하나만 관리 (constant pool)*/
...
//        System.out.println(" equals() 비교: " + integerTest.equals(integerTest2));
    ...
    public static void anythingMethod(Object obj) {     // 10 -> Integer(auto-boxing) -> Object(다형성)
        System.out.println(obj);            //Object의 toString()이 아닌 Integer의 toString()이 실행(동적 바인딩)
    }
}
