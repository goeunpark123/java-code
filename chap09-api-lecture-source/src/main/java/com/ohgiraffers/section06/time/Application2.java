...
public class Application2 {
    public static void main(String[] args) {
        ...
        /*수업목표. time 패키지의 클래스들의 가지는 필드 값들을 확인할 수 있다*/
        ...
        System.out.println("월: " + localDate.getYear());
        System.out.println("월 숫자: " + localDate.getYear());
        System.out.println("월의 몇 번째 일: " + localDate.getDayOfMonth());
        System.out.println("1년의 몇 번째 일: " + localDate.getDayOfYear());
