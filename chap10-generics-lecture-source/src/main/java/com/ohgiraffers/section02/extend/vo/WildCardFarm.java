...
/*필기.
*  와일드카드(Wildcard): 제네릭 클래스 타입의 객체를 메소드의 매개변수로 받을 때 타입 변수를 제한
*   <?>: 제한 없음
...
public class WildCardFarm {
    ...
    /*설명. 어떤 타입의 RabbitFarm(제네릭 타입)도 상관 X*/
    ...
    /*설명. RabbitFarm 중에서도 Bunny 상위 타입이 있는 RabbitFarm만 가능(Rabbit 제네릭의 농장만 가능)*/
