...
public class Application1 {
    public static void main(String[] args) {
        ...
        /*설명. 키 값은 중복되면 이후 put 되는 key와 value가 덮어씌워진다(주의)*/
        hmap.put(12, "purple banana");
        System.out.println(hmap.get(12));

        /*설명. value는 중복되어도 상관 X*/
        hmap.put(77, "purple banana");
        System.out.println(hmap);

        System.out.println("Map이 지닌 entry의 수: " + hmap.size());

        System.out.println("77번 key와 관련된 entry 삭제: " + hmap.remove(77));
        System.out.println("삭제 후 entry: " + hmap.size());

        /*필기. Map을 반복하여 각 entry(key와 value) 활용*/
        HashMap<String, String> hmap2 = new HashMap<>();

        hmap2.put("one", "java 17");
        hmap2.put("two", "mariaDB 10");
        hmap2.put("three", "servlet/jsp");
        hmap2.put("four", "stringboot 3.0");
        hmap2.put("five", "vue.js");

        /*목차 1. keySet()을 활용한 iterator*/
