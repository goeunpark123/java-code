...
public class Application3 {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            /*설명. data 입출력은 EOFException을 활용하여 파일 끝까지 입력 처리*/
