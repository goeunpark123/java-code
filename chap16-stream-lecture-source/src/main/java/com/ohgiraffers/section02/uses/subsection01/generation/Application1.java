...
public class Application1 {
    public static void main(String[] args) {
        ...
        /*수업목표. 기본적으로 배열이나 컬렉션은 스트림을 이용할 수 있다*/
        ...
        /*목차 3.
        *  Builder를 활용한 스트림 생성: Builder는 static<T>로 되어있는 메소드이며, 호출 시 타입 파라미터를 메소드 호출 방식으로 전달*/
        Stream<String> builderStream = Stream.<String>builder().add("홍길동").add("유관순").add("윤봉길").build();

        builderStream.forEach(System.out::println);

        /*목차 4. iterator()를 활용하여 수열 형태의 스트림을 생성할 수도 있다*/
